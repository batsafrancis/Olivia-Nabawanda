...
if __name__ == '__main__':
    print("area of rectanlge is: ",rectangle_area(2,3))
...
if __name__=='__main__':
    print("area of the cirle:",circle_area(7))
...
def triangle_area(base,height):
    """
calculates the area of a trianlge given the base and height of that triangle.
...
def triangle_area(a,b,c):
    ...
    print("area of triangle:",triangle_area(4,3,3))